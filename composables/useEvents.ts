...
export function useEvents() {
  ...
  const events = ref([
    ...
    {
      id: 46,
      title: `Կարգին հաղորդման ${t("TOURNAMENT")} #1`,
      slug: "kargin-haxordman-viktorina-16",
      titleDesc: "An evening of strategy, emotions and people like you",
      date: "2026-08-08",
      dateTitle: "Օգոստոսի 8",
      time: "19:30",
      price: "3000 AMD",
      location: "The Kond House - 46 Leo Street",
      image: Kargin2,
    ...
    {
      id: 50,
      title: `${t("KARAOKE_BATTLE_TITLE")} #5`,
      slug: "karaoke-battle-5",
      titleDesc: "An evening of strategy, emotions and people like you",
      date: "2026-08-14",
      dateTitle: "Օգոստոսի 14",
      time: "19:30",
      price: "4000 AMD",
      location: "The Kond House - 46 Leo Street",
      image: karaokeBattle,
    ...
    {
      id: 52,
      title: `Կարգին Սերիալ ${t("QUIZ_TITLE")} #5`,
      slug: "kargin-serial-viktorina-5",
      titleDesc: "An evening of strategy, emotions and people like you",
      date: "2026-08-23",
      dateTitle: "Օգոստոսի 23",
      time: "19:30",
      price: "3000 AMD",
      location: "The Kond House - 46 Leo Street",
      image: KarginSerial,
    ...
    {
      id: 54,
      title: `Կարգին հաղորդման ${t("TOURNAMENT")} #4`,
      ...
      category: [t("QUIZ"), t("KARGIN")],
      eventDate: true,
      emailSent: true, groupName: true, isSoldout: false, quantity: 14,
      pricePerPerson: 3000
    },
    {
      id: 55,
    ...
    },
    {
      ...
      category: [t("QUIZ"), t("KARGIN")],
      eventDate: true,
      emailSent: false, groupName: true, quantity: 8,
      pricePerPerson: 2000
    },
    {
      id: 61,
      ...
      category: t("KARAOKE"),
      eventDate: true,
      emailSent: false, groupName: false, isSoldout: true, quantity: 8,
      pricePerPerson: 4000
    },
    {
      id: 62,
    ...
    },
    {
      ...
      price: "4000 AMD",
      location: "The Kond House - 46 Leo Street",
      image: "/images/events/memesquiz.jpg",
      description:
        t("MEME_DESC"),
      category: [t("QUIZ")],
      eventDate: true,
  ...
  const eventsWithStatus = computed(() =>
    events.value.map(event => {
      ...
      return {
        ...event,
        dateTitle: formatDate(event.date),
        eventDate: !closed,
        isUpcoming: !closed,
        isClosed: closed,
      }
